...
const INITIAL_LESSONS_BASE: VideoLesson[] = [
  {
    ...
    description: 'Classes and Objects are the core concepts of Object-Oriented Programming (OOP). A class is a blueprint that defines an objects attributes and methods, while an object is an instance of a class that represents a real-world entity. In this lesson, you will learn how to create classes and objects in Java and understand how they work together to build organized, reusable, and efficient programs.',
  ...
  },
  {
    ...
    description: 'Constructors are special methods in Java that are automatically called when an object is created. They are used to initialize an objects attributes and ensure it starts with the required values.',
  ...
  },
  {
    ...
    duration: '18:15',
    status: 'active',
    videoUrl: 'http://localhost:3000/videos/lesson3.mp4',
    description: 'Object methods are functions defined inside a class that describe the actions or behaviors an object can perform. They allow objects to process data, perform specific tasks, and interact with other objects.',
